...
- `blocks/` for all `110` authored UI blocks.
...
- `content/general`: 37 blocks -> `age-gate`, `age-verification`, `blog-post`, `cards`, `cards-list`, `catalog-highlights`, `columns`, `enrichment`, `experiment-slot`, `features-grid`, `fragment`, `hero`, `hero-3`, `hero-5`, `hero-6`, `hero-cta`, `how-it-works-stats`, `how-it-works-stats-2`, `live-block`, `live-block-premium`, `luxury-configurator`, `newsletter`, `product-configurator-luxe`, `product-details`, `product-highlights`, `product-list-page`, `product-recommendations`, `product-teaser`, `promo-popup`, `promotional-hero`, `quote`, `store-locator`, `targeted-block`, `uniform-configurator`, `vip-hero-block`, `vip-member-block`, `vip-member-block-real-v2`
