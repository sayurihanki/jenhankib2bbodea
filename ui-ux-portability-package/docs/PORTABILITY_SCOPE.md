...
- `blocks/` for all `116` authored UI blocks.
...
- `content/general`: 41 blocks -> `age-gate`, `age-verification`, `blog-post`, `cards`, `cards-list`, `catalog-highlights`, `columns`, `customer-segment-personalization-block`, `enrichment`, `features-grid`, `fragment`, `hero`, `hero-3`, `hero-5`, `hero-6`, `hero-cta`, `how-it-works-stats`, `how-it-works-stats-2`, `live-block`, `live-block-premium`, `luxury-configurator`, `medal-rack-configurator`, `newsletter`, `product-configurator-luxe`, `product-details`, `product-highlights`, `product-list-page`, `product-recommendations`, `product-teaser`, `product-technical-details`, `promo-popup`, `promotional-hero`, `quote`, `store-locator`, `targeted-block`, `triptych`, `uniform-configurator`, `vip-hero-block`, `vip-hero-mccs`, `vip-member-block`, `vip-member-block-real-v2`
