...
const BASILISK_V3_PRO_35K = {
  ...
  ui: {
    regionLabel: 'Razer Basilisk V3 Pro 35K product experience',
    skipNavigationLabel: 'Skip product navigation',
    gallery: {
      showImagePattern: 'Show {alt}',
    ...
    hero: {
      deliveryHeading: 'Order now, delivered by',
      pickupHeading: 'Pickup at RazerStore',
      addToCartLabel: 'Add to cart',
      optionSelectionPattern: '{label} selected',
    },
    ...
    specifications: {
      ...
      caption: 'Razer Basilisk V3 Pro 35K full technical specifications',
    },
    related: {
      eyebrow: 'Complete your setup',
      title: 'More Gamer Gear You’ll Dig',
      cardPositionPattern: 'Product {current} of {total}',
    ...
    navigation: {
      brandAriaLabel: 'Razer product overview',
      ariaLabel: 'Razer product navigation',
      logo: {
      ...
      specificationsLabel: 'Tech specs',
      relatedLabel: 'More gear',
      buyNowLabel: 'Buy now',
    },
    footer: {
      tagline: 'FOR GAMERS. BY GAMERS.™',
      descriptor: 'Razer Basilisk V3 Pro 35K product prototype',
    },
  },
  product: {
